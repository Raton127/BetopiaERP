...
class WebClient(http.Controller):
    ...
    @http.route(['/web/webclient/bootstrap_translations', APP_WEB_ROOT + '/webclient/bootstrap_translations'], type='jsonrpc', auth="none")
    ...
    @http.route(['/web/webclient/translations', APP_WEB_ROOT + '/webclient/translations'], type='http', auth='public', cors='*', readonly=True)
    ...
    @http.route(['/web/webclient/version_info', APP_WEB_ROOT + '/webclient/version_info'], type='jsonrpc', auth="none")
    def version_info(self):
        return odoo.service.common.exp_version()

    @http.route(['/web/tests', APP_WEB_ROOT + '/tests'], type='http', auth='user', readonly=True)
    ...
    @http.route(['/web/tests/legacy', APP_WEB_ROOT + '/tests/legacy'], type='http', auth='user', readonly=True)
    def test_suite(self, mod=None, **kwargs):
        return request.render('web.qunit_suite', {'session_info': {'view_info': request.env['ir.ui.view'].get_view_info()}})

    @http.route(['/web/bundle/<string:bundle_name>', APP_WEB_ROOT + '/bundle/<string:bundle_name>'], auth='public', methods=['GET'], readonly=True)
